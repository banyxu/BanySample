...
(function () {
    ...
    IconLayer.prototype = {
        ...
        ShowPointIcon: function (name, points, left, top, textStyle) {//标识文字
        ...
        CreateTextStyle: function (text, left, top, layerName, textStyleOption) {
            var self = this;
